...
<form method="POST" action="{{route('cours.update',['cour'=>$cour->id])}}">
    @csrf
    @method('PUT');
    ...
    <input class="form-control" name="libele" id="libele" value="{{old('libele',$cour->libele)}}" placeholder="libele" type="text" required>
        </div>
